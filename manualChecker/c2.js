...
let cat = "Assignment_04_Category_002";
...
function generateLogs2() {
  ...
  try {
    ...
    console.log("Solution      112.5 | 15 | 30 | Invalid");
  } catch (error) {
    console.log("error in calculateVAT:", error);
  }
  console.log("-------------------------------------------");
  try {
    console.log(
    ...
    console.log("error in validContact:", error);
  }
  console.log("-------------------------------------------");
  try {
    console.log(
    ...
    console.log("error in willSuccess:", error);
  }
  console.log("-------------------------------------------");
  try {
    console.log(
    ...
    console.log("error in validProposal:", error);
  }
  console.log("-------------------------------------------");
  try {
    console.log(
    ...
    console.log("error in calculateSleepTime:", error);
  }
  console.log("-------------------------------------------");
}
